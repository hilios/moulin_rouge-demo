...
# Comments
Comment.create(:post => first,  :from => "Jhon",    :message => "Just awesome!"             ) { |comment| comment.approved = true }
Comment.create(:post => first,  :from => "Cindy",   :message => "It was very usefull to me.") { |comment| comment.approved = true }
Comment.create(:post => first,  :from => "Carl",    :message => "I hated!"                  ) { |comment| comment.approved = false }

Comment.create(:post => second, :from => "Justin",  :message => "Boring..."                 ) { |comment| comment.approved = true }
Comment.create(:post => second, :from => "Carl",    :message => "TL; DR;"                   ) { |comment| comment.approved = false }

Comment.create(:post => third,  :from => "James",   :message => "Really interesting."       ) { |comment| comment.approved = true }